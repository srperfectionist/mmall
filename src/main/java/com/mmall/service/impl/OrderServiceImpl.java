...
public class OrderServiceImpl implements IOrderService {
     ...
     */
    @Override
    public ServerResponse<Object> crateOrder(Integer userId, Integer shippingId) {
        //获取购物车选中商品
    ...
    public ServerResponse getOrderCartProduct(Integer userId) {
        ...
        orderProductVo.setImageHost(PropertiesUtil.getPropertyToString("ftp.server.http.prefix"));
    ...
    private OrderVo assembleOrderVo(Order order, List<OrderItem> orderItemList) {
        ...
        orderVo.setImageHost(PropertiesUtil.getPropertyToString("ftp.server.http.prefix"));
    ...
    private BigDecimal getOrderTotalPrice(List<OrderItem> orderItemList) {
        BigDecimal payment = new BigDecimal("0");
        for (OrderItem orderItem : orderItemList) {
            payment = BigDecimalUtil.add(payment.doubleValue(), orderItem.getProductId().doubleValue());
        }
        return payment;
    }
    ...
    private ServerResponse getCartOrderItem(Integer userId, List<Cart> cartList) {
        ...
        for (Cart cartItem : cartList) {
            ...
            orderItem.setTotalPrice(BigDecimalUtil.multiply(cartItem.getQuantity().doubleValue(), product.getPrice().doubleValue()));
    ...
    public ServerResponse pay(Integer userId, Long orderNo, String path) {
        ...
        String subject = new StringBuilder().append("商城扫毛支付，订单号:").append(outTradeNo).toString();
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
                ...
                .setNotifyUrl(PropertiesUtil.getPropertyToString("alipay.callback.url"))
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                String qrUrl = PropertiesUtil.getPropertyToString("ftp.server.http.prefix") + targetFile.getName();
    ...
    public ServerResponse aliCallback(Map<String, String> params) {
        ...
        if (order == null) {
            return ServerResponse.createByErrorMessage("非商城订单，忽略回调");
        }
        ...
        payInfo.setPayPlatform(Const.OrderStatusEnum.PAID.getCode());
